...
# 2024-2025 学年秋冬学期物理化学期中回忆卷

<!--
source-attribution
编写：李建树。
资料性质：2024-2025 学年秋冬学期期中回忆卷，含 25 道单项选择题及计算、证明题。
说明：选择题奖励分规则按原记录保留。
来源记录：PC-EXAM-USER-20260907。
-->
...
17. 假设我们的教室（尺寸按 $5~\mathrm{m} \times 5~\mathrm{m} \times 5~\mathrm{m}$ 计）充满了 $\mathrm{O_2}$ 理想气体，请估算在常温常压下，这些 $\mathrm{O_2}$ 分子总的平动热能大约为多少数量级（单位：$\mathrm{J}$）？
...
18. 关于公式 $\Delta S = C_V\ln \dfrac{T_{\mathrm{终}}}{T_{\mathrm{始}}}$ 以及其推导过程，下列说法错误的是：
...
1. （4 分）计算该过程的终态温度和终态压强。

2. （8 分）计算该过程的 $q$、$w$、$\Delta U$ 和 $\Delta H$。
