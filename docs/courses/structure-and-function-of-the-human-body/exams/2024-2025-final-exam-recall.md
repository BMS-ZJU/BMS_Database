---
title: 人体结构与功能学 2024-2025 学年春夏学期期末回忆卷
---

# 2024-2025 学年春夏学期人体结构与功能学期末回忆卷

<!--
source-attribution
资料上传：李建树；协助回忆：范晶晶、彭于哲、辛紫煊、薛婧彤。
原始出处：https://www.cc98.org/topic/6221622。
资料性质：考后回忆，记录 36 道选择题、6 道简答题和 2 道分析题；原卷共 68 题。
整理说明：选择题题号与选项基本为乱序，页面题号仅供查阅；“—”表示回忆缺失。
...
!!! info "回忆卷说明"
    ...
    现有回忆记录了 44 道题，原卷题量为 68 道；“—”表示该处未能回忆完整。

    选择题的题号和选项基本为乱序；页面中的题号仅用于整理和查阅，题目次序及各题选项次序不代表原卷顺序。
...
2. What are the structural characteristics of cells that secrete peptide/protein hormones and steroid hormones（肽类/蛋白质类激素与甾体类激素）? What are the characteristics of the transport and action model of the hormones?
...
6. What parts does the seminiferous tubule（生精小管）wall structure include? What is the main cellular component?
...
2. Because of the hot weather, a student drank a bottle of water (500 mL) in a short time.

    (1) What change will occur in the osmotic pressure（渗透压）of the student's urine compared with normal drinking water?
