...
找到课程后，可以进入该课程已有的“考试资料”“平时小测”“讨论课”或“课程笔记”等分组。每门课收录的资料不同，具体以课程页列出的内容为准。
...
- [医学生物物理学课程笔记](../courses/medical-biophysics/notes/index.md)：查看三份往届同学整理的PDF笔记。
...
在试卷或小测页面点击“打印 / 导出”，进入独立导出页。支持按次选择的合集从正在阅读的小测进入时，默认选择当前材料；打印前请先核对显示的范围。

需要调整时，点击打印范围旁的“更改”，勾选要打印的小测或练习，也可以全选。预览按原资料顺序排列，每份资源的标题与正文从新页开始。
