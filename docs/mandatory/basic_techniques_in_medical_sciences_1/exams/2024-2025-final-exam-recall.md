...
<!--
source-attribution
发布：李建树；参与回忆：高世晨、辛紫煊、赵媚佳。
原始出处：https://www.cc98.org/topic/6089971。
资料性质：2024-2025 学年冬学期、2023级期末回忆。
整理说明：选择题采用整理序号，选项字母按回忆记录顺序编排；DH5α题干与BL21选项的原有差异保留。
来源记录：RS-005。
-->
...
## 三、计算题（15 分） {: .exam-section .exam-section--analysis data-toc-label="三、计算题" }
...
## 四、分析题（15 分） {: .exam-section .exam-section--analysis data-toc-label="四、分析题" }
