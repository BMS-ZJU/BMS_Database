...
- **2023-2024 学年：**只有一道题，要求结合 AI 与发育生物学提出科学问题和实验设计，作答 1000—1500 字；可使用不联网、仅用于查看资料的电脑。 来源：[Bering 的回忆](https://www.cc98.org/topic/5876395)。
...
- **预修要求：**无。
- **实际学习需要：**具备高中阶段遗传与进化的基础就可以开始学习，包括遗传规律、减数分裂与受精、DNA 与基因表达、遗传变异和生物进化。
