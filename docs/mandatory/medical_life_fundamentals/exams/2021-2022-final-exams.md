---
title: 生命科学基础 2021-2022 学年秋冬学期期末 A/B 卷及参考答案
---

# 2021-2022 学年秋冬学期生命科学基础期末 A/B 卷及参考答案

<!--
source-attribution
贡献者：谷雨桦（A/B 卷上传）；pzl、杨莹硕（补充核验资料提供）。
原始出处：钉钉群分享的 A/B 卷及答案；另收语雀 A 卷原件与 A 卷回忆版作为核验资料。
资料性质：原始试卷及随附参考答案。
整理说明：A/B 卷分组收录，答案沿用各卷原材料；以原始试卷为正文依据。
...
2. 下列关于细菌的叙述正确的是： ( )
    ...
    **C.** 细菌依靠芽孢进行繁殖  
    **D.** 将食品放在冰箱中可防止腐败变质的原因是低温杀死了细菌等微生物
...
5. The specialized function shared by the cells that line the lungs and those that line the lumen of the gut is that both types of cells： ( )
...
1. Please describe the process of gene expression control.

2. Why Mimivirus (size 400 nm; 1000 genes) and Pandoravirus (size 700 nm; 2556 genes) still are viruses?

3. What are the common and different properties between normal stem cells and cancer stem cells？How can we treat cancer based on these properties?
...
1. Talk about the significance of human civilization and technological innovation from the perspective of human evolution and disease，you can give an example to illustrate.
...
3. 下面关于脂类的功能说法不正确的是： ( )
    ...
    **A.** 脂类是脂肪、磷脂、类固醇等类化合物的总称  
    **B.** 脂类是生物膜的主要成分  
    **C.** 脂肪氧化时产生的能量大约是糖氧化时的二分之一  
    **D.** 脂类是保持体温的生物活性物质

4. 近年来细胞图谱技术在中医药领域应用开始显现，相对于常规的实验动物研究、通过细胞图谱来研究中医药理论的主要优势在于： ( )
...
5. Why do RNA viruses appear to have higher rates of mutation? ( )
...
Please describe the procedure of the polymerase chain reaction and its application.

</li>
<li markdown="block">

What are the special structures of bacteria? Please explain separately.

</li>
<li markdown="block">

Where does the antibody come from and how does it work？

</li>
<li markdown="block">

Please briefly describe the generalized life cycle of fungi.
...
3. 肿瘤干细胞与正常干细胞的异同及治疗策略：
    ...
    **A.** 将两者不同的信号通路作为治疗的靶点，如肿瘤抑制蛋白通路在正常造血干细胞的自我更新和白血病的形成中具有不同的作用途径。  
    **B.** 利用干细胞分化的特性，开发相关小分子化合物将肿瘤干细胞分化成正常的成熟细胞。

4. 简述现代人类起源的化石与基因之争的各自主要观点：
