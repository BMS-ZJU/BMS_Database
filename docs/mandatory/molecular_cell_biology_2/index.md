...
现有两个学年的资料都记录了出勤、学习笔记、文献图文摘要和课堂测试；课堂测试均为 3 次线下闭卷。2025-2026 学年的学习笔记需要电子手写或纸质手写，在最后一次课检查；图文摘要需要阅读指定文献后绘制，在冬学期结束前提交。

出勤和测试安排有一些学年差异。2025-2026 学年有 2 次请假机会，请假需要提前填表；测试安排在各大模块的最后一次课，由助教监考，任课教师也会在教室巡视。2024-2025 学年的出勤偶尔通过学在浙大或口头点名。各项占比见下方对应学年的分数构成。
