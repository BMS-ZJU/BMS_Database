...
**考试准备。** 解剖学实验考试春、夏学期各有一次，准备考试只需要学到给出图片认出对应器官或部位即可。组织学实验考试则主要使用[基础医学信息化实验平台](http://10.71.148.20/mengoo/)的题库，最直接的准备方法是反复练习钉钉群中的“人解组织形态学期中测试复习题库”进行拟合。按现有经验，同一场考试中不同同学拿到的题目内容基本相同，主要是顺序不同；具体仍以当年平台安排为准。
