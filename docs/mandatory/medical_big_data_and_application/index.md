...
原始出处：https://www.cc98.org/topic/5644602。
来源记录：RESOURCE-AUDIT-FEEDBACK-20260908 / R03b、CONSENT-ATTRIBUTION-20260915。
-->

课程包括医学数据相关理论和 R 语言两部分。理论课讨论医学数据怎样产生、表示、交换和用于临床与科研；R 语言课从基础语法和数据结构开始，逐步进入统计分析与生物数据处理。两部分在课程中相对独立。
...
当年期末考试为全英文闭卷，可以携带英汉词典。20 道单项选择题，共 40 分；11 道简答题，共 60 分。
...
- **开课与学分：**夏学期，2 学分。
- **预修要求：**无预修要求。
- **实际学习需要：**有其他编程语言基础会更容易上手，没有也不影响修读，可以借助 AI 边做边学。
